...
if TYPE_CHECKING:
    ...
    VLLM_OMNI_MINIMAX_H3_TE_RESIDENT: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Set "1" to keep a staged text encoder on the device after its first
    # encode: startup still parks it, later phases skip the copy-in.
    "VLLM_OMNI_MINIMAX_H3_TE_RESIDENT": lambda: os.environ.get("VLLM_OMNI_MINIMAX_H3_TE_RESIDENT", None),
