...
_PUBLIC_OMNI = (
    ...
    "VLLM_OMNI_DIFFUSION_STAGGER_COMPONENT_LOAD",
    "VLLM_OMNI_DIFFUSION_STARTUP_MEM_TRACE",
    "VLLM_OMNI_DIFFUSION_STARTUP_MEM_TRACE_LAYERS",
    "VLLM_OMNI_DIFFUSION_STARTUP_MEM_SNAPSHOT",
    "VLLM_OMNI_DIFFUSION_STARTUP_MEM_SNAPSHOT_HOST",
    "VLLM_OMNI_DIFFUSION_STARTUP_MEM_SNAPSHOT_DIR",
    "VLLM_OMNI_EVENT_DRIVEN_ORCH",
    "VLLM_OMNI_FUSED_QK_NORM_ROPE_MIN_TOKENS",
    "VLLM_OMNI_INPUT_WAIT_TIMEOUT_S",
    "VLLM_OMNI_MINIMAX_H3_STAGED_COMPONENTS",
    "VLLM_OMNI_MINIMAX_H3_TE_RESIDENT",
